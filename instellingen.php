...
<body>
	...
	<?php	
		include_once('class/openingsuren.class.php');
			...
			<h3 id="voormiddag">Middag</h3>
			<h3 id="namiddag">Avond</h3>
			<label for="maandag">Maandag</label>
				...
				<hr width='99%' color='#ddd1af' size='1'>
				...
				<div class="cf"></div>
				<p id="uur-info">Laat de velden leeg indien u op de desbetreffende dag niet open bent</p>
